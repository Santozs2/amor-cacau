              ...
              <div className="flex flex-wrap gap-2">
                {(['orders', 'products', 'customers', 'comments'] as const).map(tab => (
                  <button
                    ...
                    className={`rounded-full border px-4 py-2 text-sm font-medium transition ${activeTab === tab ? 'border-[#2D160C] bg-[#2D160C] text-white' : 'border-[#D9C9B2] bg-white text-[#6E5A4D]'} cursor-pointer hover:bg-[#F1D8CA]`}
                  >
                ...
                <div>
                  <div className="mb-4 flex items-center justify-between">
                    ...
                    <button 
                      ...
                      className="flex items-center gap-2 rounded-full bg-[#FAF6F0] border border-[#E0D8C8] px-4 py-2 text-sm font-bold text-[#2D160C] transition hover:bg-[#F1D8CA] disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed"
                    >
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-center bg-[#FAF8F3] p-5 rounded-3xl border border-[#F0E6DD]">
                    ...
                    <button 
                      ...
                      className="bg-[#2D160C] text-white px-5 py-2.5 rounded-full flex items-center gap-2 text-sm font-bold uppercase tracking-[0.2em] hover:bg-[#3F210E] transition shadow-md cursor-pointer"
                    >
                      ...
                      <div key={product.id} className="rounded-3xl border border-[#F0E6DD] p-4 bg-white shadow-sm relative group overflow-hidden flex flex-col justify-between">
                        <div className="absolute top-2 right-2 flex gap-2 opacity-0 group-hover:opacity-100 transition">
                          <button 
                            ...
                            className="bg-blue-100/90 text-blue-600 p-2 rounded-full hover:bg-blue-200 transition cursor-pointer" 
                          ...
                          <button 
                            ...
                            className="bg-red-100/90 text-red-600 p-2 rounded-full hover:bg-red-200 transition cursor-pointer"
                            title="Remover Item"
                          >
                            <Trash2 size={16} />
                          </button>
