      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-[#F0E6DD]">
        ...
        <div className="bg-[#FAF6F0]/50 p-8 rounded-2xl border border-[#F0E6DD]">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            >
              <a href="mailto:amorecacaurp@gmail.com"><span>Enviar Mensagem</span></a>
              <Send size={18} className="transform group-hover:translate-x-0.7 group-hover:-translate-y-0.7 transition-transform" />
            </button>
          </form>
        </div>
