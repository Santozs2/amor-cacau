    ...
    <div className="flex flex-col flex-grow p-6 space-y-4">
      ...
      <div className="flex items-center justify-between pt-4 border-t border-[#F0E6DD]">
        ...
        <button 
          ...
          className="bg-[#2D160C] text-white p-3.5 rounded-full hover:bg-[#E0B58C] hover:text-[#2D160C] transition-all duration-300 hover:scale-110 active:scale-95 shadow-md z-20"
        >
